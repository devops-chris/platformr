...
// directory/file contents treat this as "zero results", not an error, so an empty
// list reaches the picker as an empty list rather than an error that masks it.
